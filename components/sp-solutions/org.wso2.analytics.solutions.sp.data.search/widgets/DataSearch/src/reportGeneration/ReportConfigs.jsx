...
class ReportConfigs extends Component {
    ...
    saveBtnClicked(){
        if(this.state.type == "table"){
            PdfReportGenerator.createTablePdf(this.props.element, this.props.theme, this.state.title, this.state.description);
        }else{
        ...
        return (
            <div style={{marginTop: 0, marginBottom: 0}}>
                <TextField
                    ...
                    style={{minWidth:400,color:"#fc5800", marginTop: 0, marginBottom: 0}}
                /><br/><br/>
