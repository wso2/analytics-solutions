...
/**
 * Source <a href="/home/tharindu/workspace/projects/probation/AnalyticsOnSP/SP/wso2sp-4.3.0-M1/wso2/dashboard/deployment/web-ui-apps/portal/extensions/widgets/MediatorProperties/MediatorProperties/MediatorProperties.js">diff_match_patch</a>
 */
(function () {
    ...
    diff_match_patch.prototype.diff_cleanupMerge = function (a) {
        ...
        for (b = 1; b < a.length - 1;) {
            0 == a[b - 1][0] && 0 == a[b + 1][0] && (a[b][1].substring(a[b][1].length - a[b - 1][1].length) == a[b - 1][1] ? (a[b][1] = a[b - 1][1] + a[b][1].substring(0, a[b][1].length - a[b - 1][1].length), a[b + 1][1] = a[b - 1][1] + a[b + 1][1], a.splice(b - 1, 1), c = !0) : a[b][1].substring(0,
